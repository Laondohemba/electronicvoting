...
if (isset($_SESSION["admin"])) {
    ...
    $sql = "SELECT * FROM elections WHERE adminID = :adminID;";
                                ...
                                <div class="col-md-4 my-2">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="#">Add Voters</a></li>
                                            <li><a class="dropdown-item" href="#">Add Contestants</a></li>
                                            <li><a class="dropdown-item" href="#">Voters</a></li>
                                            <li><a class="dropdown-item" href="#">Contestants</a></li>
